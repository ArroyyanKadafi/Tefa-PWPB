    ...
    <div class="container">
      ...
      <table class="table table-bordered" id="example">
        ...
        <tbody>
          ...
          <?php $totalbelanja = 0; ?>
          <?php 
              $ambil = $conn->query("SELECT * FROM pemesanan_produk JOIN produk ON pemesanan_produk.id_menu=produk.id_menu 
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2021 -  Designed by Arroyyan Kadafi</p>
          </div>
          </div>
